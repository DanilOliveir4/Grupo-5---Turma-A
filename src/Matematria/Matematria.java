...
public class Matematria {
    ...
    public static String nomePersonagem;// Variável nomePersonagem Global para usar em todos os capítulos.

    public static void main(String[] args) {
        mainMenu();// Chama o método mainMenu.
    }

    public static void mainMenu() {
        Scanner scanner = new Scanner(System.in);
        int escolhaMenu;  // Direciona o usuário para a opção escolhida.

        do {    // Laço para repetir o menu caso necessário.
            ...
            if (escolhaMenu == 1) {
                iniciaJogo(); // Chama o método iniciaJogo.
            } else if (escolhaMenu == 2) {
                exibeInformacoes(); // Chama o método exibeInformaçoes.
            } else if (escolhaMenu == 3) {
                exibeCreditos(); // Chama o método exibeCreditos.
            } else if (escolhaMenu == 4) {
                System.out.println("Obrigado por jogar!");
                System.exit(0); // Encerra o código.
            } else {
                System.out.println("Opção inválida. Por favor, escolha uma opção válida."); // Caso digite uma opção diferente ou igual a 4 aperece a mensagem e roda o menu denovo.
            }
        } while (escolhaMenu != 4);
    }

    public static void iniciaJogo() {
        capitulo1(); // Chama o método capitulo1 e executa a história dentro dele.
        capitulo2(); // Chama o método capitulo2 e executa a história dentro dele.
        capitulo3(); // Chama o método capitulo3 e executa a história dentro dele.
        capitulo4(); // Chama o método capitulo4 e executa a história dentro dele.
    }

    public static void exibeInformacoes() { // Exibe as informações do jogo, do que se trata a história e o que poder esperar.
        ...
        System.out.println("habilidades e determinação.Determine suas Falas, aprimore sua mente e se aprofunde nessa aventura.");

    }

    public static void exibeCreditos() { // Nome dos desenvolvedores.
        System.out.println("Desenvolvedores: \nDaniel Branco de Oliveira Filho; \n"
                + "Jhowsemir Fernandes. ");

    }

    public static void gameOver() {  // Executa quando o jogador errar a resposta, dara a opção de voltar ao menu ou reiniciar o jogo.
        Scanner scanner = new Scanner(System.in);
        System.out.println("""
                            ########################################################################################################################
                           ########################################################################################################################
                           ...
                           ########################################################################################################################
                           ########################################################################################################################
                           ########################################################################################################################"""); // Imagem em ASCII para deixar uma imersão maior no jogo.
        System.out.println("");
        int escolhaGameOver;
        do { // Laço para caso o jogador escolha uma opção inexistente rode dnv.
            ...
            escolhaGameOver = scanner.nextInt(); // Pega a decisão do usuário.
            if (escolhaGameOver == 1) {

                mainMenu(); // Volta pro menu.
            } else if (escolhaGameOver == 2) {

                iniciaJogo(); // Reinicia o jogo.
            } else {
                System.out.println("Opção inválida. Por favor, escolha uma opção válida.");
            }
        } while (escolhaGameOver < 1 || escolhaGameOver > 2);
        System.out.println(" ------------------------------------------------------------------------------------ ");
    }

    public static void capitulo1() { // inicio do capítulo 1.
        Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("3- Obrigado mas vou dobrar e passar para o próximo.");

        int escolha1; // Primeira escolha do usuário nesse caso não tem certo ou errado apena um dialogo.

        do { // Laço para caso escolha uma opção inexistente repita o processo.
        ...
        if (escolha1 == 1) {   // Textos diferentes para determinadas escolhas.
        ...
        // Textos narrativas, para a inserção na jornada.
        System.out.println("Sua jornada se inícia agora, que Newton o guie em sua busca.");
        System.out.println("");
        ...
        int escolha2; // Outrra escolha, novamente em mais um diálogo onde não tem certo ou errado, apenas se digitar uma opção inexistente. 

        do { // Laço para repitir o processo caso o usuário insira uma opção inexistente.
        ...
        if (escolha2 == 1) { // Textos diferentes para determinadas escolhas.
            ...
            System.out.println(nomePersonagem + ": Onde eu estou e que lugar é esse?");
        ...
        int escolha3; // Mais uma escolha, novamente diálogo.
        ...
        int escolha4; // Outra escolha, mas essa é o marco do inicio dos desafios,
        ...
        // Textos para a inserção do primeiro desafio.
        ...
        // Dica, meio que um tutorial de como sobreviver ao jogo, todas as questôes seguiram a mesma base.
        System.out.println("Voz de Matematria: Lhe darei uma dica de como resolver qualquer equação de 2º grau, (Delta = b² - 4ac ,  x = - b +- Raiz de Delta / 2a) Bhaskara, (x^2 - 5x + 6 = 0 ,  x1 + x2 = 5\n"
        ...
        double resposta1; // Primeira resposta, as repostas estaram sempre separadas em duas, uma em seguida da outra, em qual uma será a primeira raiz da equação, e a segunda a segunda raiz.
        double resposta2; // Não se importe com a ordem das raizes, se uma equação de por raizes 1 e 2 não importara a ordem em que foi digitada, pode ser tanto 2 e 1 quanto 1 e 2.

        System.out.print("x' = ");
        resposta1 = scanner.nextDouble(); // Armazena resposta.
        System.out.print("x'' = ");
        resposta2 = scanner.nextDouble(); // Armazena resposta.

        if (resposta1 == -7 && resposta2 == 3) { // Como falado anteriormente, aqui está o teste, se a resposta for -7 e 3 está correto.
        ...
        } else if (resposta1 == 3 && resposta2 == -7) { // E se for 3 e -7 também está correto.
            System.out.println("Com um gesto rápido, você resolve o problema matemático. As paredes se afastam, e você está livre da primeira cápsula.");
        } else {
            gameOver(); // Errou usa chama o método game over.
            return; // Para o código pós game over.
        }
    ...
    public static void capitulo2() {
        ...
        System.out.println("");
        System.out.println("Neste capítulo, você continuará a enfrentar desafios matemáticos em Matematria, incluindo um desafio de resolução de equações de segundo grau.");
        System.out.println("Voce está preparado?");
        System.out.println("1- Sim.");
        System.out.println("2- Não");

        int opcao1; // Primeira escolha do capítulo 2.

        do { // Laço para garantir que o usuário digitou uma opção válida.
        ...
        System.out.println("É melhor você se apressar para evitar ser atingido. Voz de Matematria: Você chegou na caverna, pode descansar!");
        ...
        System.out.println("Não há necessidade de ficar ansioso para resolver essa equação, mas lembre-se de que Matemátria depende de você.");
        System.out.println("vamos lá " + nomePersonagem + " você já se lembra de como resolver equações de 2 grau né? é preciso de muito foco, chegou sua hora, agora dependem de você, abra a cápsula e resolva a conta  ");
        System.out.println("Fiiiiiiinnnnnuuum: Som de cápsula se abrindo");

        // Segundo desafio do jogo.
        System.out.println(nomePersonagem + ", Resolva a seguinte equação: -x^2 -4x +5 = 0");
        System.out.println("Digite a sua resposta: ");
        ...
        System.out.print("x' = ");
        opcao2 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        opcao3 = scanner.nextDouble(); // Armazena a resposta.

        if ((opcao2 == -5 && opcao3 == 1) || (opcao2 == 1 && opcao3 == -5)) { // Teste para verificar se a resposta está correta.
            ...
            gameOver(); // Errou chama o método gameOver.
            return; // Encerra o jogo a partir daqui.
        }

        // Continuação dos textos.
        System.out.println();
        System.out.println("Perceba, não foi tão complicado quanto parecia alcançar isso. Parabéns!");
        ...
        System.out.println("Martiarcs: Saudações,habitante da Terra! Estamos muito satisfeitos por fazer a sua acolhida e estamos ansiosos para contar com a sua participação\n"
                + " em novos desafios que estão por vir.");
        System.out.println("");
        System.out.println("Martiarcs: " + nomePersonagem + ", Podemos contar com você?");
        System.out.println("1- Sim.");
        System.out.println("2- Claro");

        int opcao4; // Outra escolha, agora um diálogo.
        ...
        prossegueTexto();
        System.out.println();
        System.out.println("Maravilha, é notavel o seu desempenho para poder ajudar tudo e todos! Espero que já tenha percebido que a sua jornada é mais do que apenas sobreviver");
        ...
        System.out.println("sorte que no meio do caminho você fez aliados, e os martiarc irão levar para você a chave necessária para abrir a porta. Mas antes disso, é necessario resolver um novo desafio: ");

        // Terceiro desafio presente no jogo.
        ...
        System.out.print("x' = ");
        opcao5 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        opcao6 = scanner.nextDouble(); // Armazena a resposta.

        if ((opcao5 == 12 && opcao6 == -8) || (opcao5 == -8 && opcao6 == 12)) { // Verifica se está correto.
            System.out.println("Os Martiarcs conseguiram resolver e desbloquearam a chave necessária para a sua libertação."); // Executa o texto e segue o código.
        } else {
            gameOver(); // Chama o método gameOver.
            return; // Encerra o jogo a partir daqui.
        }

        System.out.println(nomePersonagem + "Fico contente por ter vocês ao meu lado. Se não fosse por vocês, ainda estaria preso. agradeço imensamente!");
        System.out.println("Martiarc: Estamos juntos agora, um pelo outro ate o fim!");
        System.out.println("Voz de Matemátria: muito bem " + nomePersonagem + ",com muitas lutas e esforço, você conseguiu completetar todos os desafios");
        System.out.println("mas ainda não terminou, grandes aventuras te esperam e que você possa completar todas e sair vivo desse planeta!");
    ...
    public static void capitulo3() {
        ...
        ArrayList<String> eventosAleatorios = new ArrayList<>(); // Array criado para usar como desafios aleatórios.
        ...
        Random random = new Random(); // Random para escolher um desafio do array aleatoriamente.

        String eventoAleatorioEscolhido1 = eventosAleatorios.get(random.nextInt(eventosAleatorios.size())); // Random para escolher um desafio do array aleatoriamente.

        String eventoAleatorioEscolhido2; // Separação de variaveis exercicios aleatórios para conseguir fazer testes e garantir que são diferentes.

        do { // Teste para garantir que cada evento aleatório é diferente.
        ...
        String eventoAleatorioEscolhido3; // Outro evento aleatório.
        ...
        int escolha5; // Primeira escolha do capítulo.
        ...
        if (escolha5 == 1) { // Executa o texte referente a escolha.
        ...
        } else if (escolha5 == 2) { // Executa o texte referente a escolha.
        ...
        } else if (escolha5 == 3) {  // Executa o texte referente a escolha.
        ...
        System.out.println("2. incrivel, já posso voltar pra casa?");
        System.out.println("3. espero que essa lenda termine com o forasteiro inteiro e vivo.");

        int escolha6; // Outra escolha, novamente um diálogo.
        ...
        switch (escolha6) { // Uso do switch para diferenciar um pouco no código, executa case correspondente a escolha.
            case 1 ->
        ...
        int escolha7; // Mais uma escolha, outro diálogo.
        ...
        if (escolha7 == 1 || escolha7 == 2) { // Executa o código referente a escolha.
        ...
        System.out.print("x' = ");
        resposta3 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        resposta4 = scanner.nextDouble(); // Armazena a resposta.

        if (resposta3 == 4 && resposta4 == -4) { // Verifica se a resposta está correta e executa o texto.
            ...
            System.out.println(nomePersonagem + " Rapidamente pega uma pedra e rabisca ao lado da equação a resposta!");
        } else { // Errou chama o método gameOver.
        ...
        int escolha8; // Mais um diálogo, só que esse tem uma consequência a depender da escolha do usuário.

        do { // Laço para verificar se o usuario digitou uma opção válida.
        ...
        if (escolha8 == 1) { // Executa o texto destinado a opção.
        ...
        } else if (escolha8 == 2) { // Executa o texto destinado a opção.
            System.out.println("Todos morrem sua jornada acaba aqui.");
            gameOver(); // consequência da escolha o jogo acaba aqui e chama o método gameOver.
            return; // Encerra o jogo a partir daqui.
        }

        // Uso do primeiro desafio aleatório.
        ...
        System.out.print("x' = ");
        double resposta5 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        double resposta6 = scanner.nextDouble(); // Armazena a resposta.

        switch (eventoAleatorioEscolhido1) { // switch para para verificar qual desafio está na variável eventoAleatorioEscolhido1, e destinar a resposta correta para o desafio.
            case "- 3x^2 + 18x - 15 = 0": // se o desafio aleatório for - 3x^2 + 18x - 15 = 0, a resposta pra ele é a solucao1Evento1 e solucao2Evento1.
                double solucao1Evento1 = 1;
                double solucao2Evento1 = 5;
                if ((resposta5 == solucao1Evento1 && resposta6 == solucao2Evento1) || (resposta5 == solucao2Evento1 && resposta6 == solucao1Evento1)) { // Teste para verificar se a resposta está correta.
                    System.out.println("Parabéns! Você salvou a todos, incluindo a si mesmo.");
                } else {
                    System.out.println("Sua aventura Termina aqui.");
                    gameOver(); // caso errar chama o método gameOver e encerra o jogo.
                    // Essa lógica se aplica em todas as outras cases.
                }
                break;
            case "- 2x^2 + 3x + 5 = 0":
        ...
        System.out.println("salvar ambos os mundos está em suas mãos.Vocês se preparam para o confronto final,");
        System.out.println("Matematria e a Terra depende do sucesso de sua missão. A batalha pela verdade e pela salvação começa agora!");
    ...
    public static void capitulo4() {
        Scanner scanner = new Scanner(System.in);
        ArrayList<String> eventosAleatorios = new ArrayList<>(); // Outro array list.
        ...
        Random random = new Random(); // Random para selecionar um desafio aleatoriamente.

        String eventoAleatorioEscolhido1 = eventosAleatorios.get(random.nextInt(eventosAleatorios.size())); // Armazena o primeiro desafio.

        String eventoAleatorioEscolhido2; // Armazena o segundo desafio.

        do { // Teste para verifica se os desafios são diferentes.
            eventoAleatorioEscolhido2 = eventosAleatorios.get(random.nextInt(eventosAleatorios.size()));
        } while (eventoAleatorioEscolhido2.equals(eventoAleatorioEscolhido1));

        String eventoAleatorioEscolhido3; // Armazena o terceiro desafio.
        ...
        System.out.println("1 - acho que um carteado cairia bem neste momento");
        System.out.println("2 - sinceramente gostaria de nao ter que ficar com essa escolha D:");
        System.out.println("3 - o que estamos esperando? vamos entrar e dar uma surra de lógica neles!");

        int escolha1; // Primeiro diálogo do capítulo.

        do { // Laço para garantir que o usuario digitou uma opção válida.
            escolha1 = scanner.nextInt();
            if (escolha1 < 1 || escolha1 > 3) {
                System.out.println("Matiarcs: Como assim? não entendi. ");
            }
        ...
        if (escolha1 == 1) { // Executa o texto referente a escolha.
        ...
        System.out.println("1 - Casos de familia ao vivo KSKS, sinto muito de atrapalhar esse reencontro mas preciso eu vou salvar minha terra natal, se necessário");
        System.out.println("passerei por cima de voces sem remorso algum.");
        System.out.println("2 - Tudo bem chega de papinho, dissindentes tenho uma proposta para voces, que tal desistirem agora e ai eu nao acabo com a raça de voces.");
        System.out.println("Escolha 1 ou 2:");
        int escolha2; // Mais um diálogo.
        ...
        if (escolha2 == 1 || escolha2 == 2) { // Continua a execução do textp.
        ...
        switch (eventoAleatorioEscolhido1) { // switch para para verificar qual desafio está na variável eventoAleatorioEscolhido1, e destinar a resposta correta para o desafio.
            case "x2 - 5x - 14 = 0": // se o desafio aleatório for x2 - 5x - 14 = 0, a resposta pra ele é a solucao1Evento1 e solucao2Evento1.
                double solucao1Evento1 = -2; // recebe as respostas corretas.
                double solucao2Evento1 = 7; // recebe as respostas corretas.
                if ((resposta5 == solucao1Evento1 && resposta6 == solucao2Evento1) || (resposta5 == solucao2Evento1 && resposta6 == solucao1Evento1)) { // Teste para verificar se a resposta está correta.
                    System.out.println("Okay okay deu certo vamos para a próxima.");
                } else {
                    System.out.println("Sua aventura Termina aqui.");
                    gameOver(); // se erra chama o método gameOver e o jogo se encerra aqui.
                    // A mesma lógica está aplicada nas outras cases.
                }
                break;
            case "x^2 - 12x + 20 = 0":
        ...
        // Sexto desafio do jogo.
        System.out.println("Quase sem energia, você consegue chegar perto o suficiente para enxergar a equação, e começa a resolver a seguinte equação " + eventoAleatorioEscolhido2 + ". " + nomePersonagem + " Desenha com os dedos nesse");
        System.out.println("possível infinito chamado de Cápsula da Matemática a sua resposta:");
        System.out.print("x' = ");
        double resposta1 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        double resposta2 = scanner.nextDouble(); // Armazena a resposta.

        switch (eventoAleatorioEscolhido2) { // switch para para verificar qual desafio está na variável eventoAleatorioEscolhido2, e destinar a resposta correta para o desafio.
            case "x2 - 5x - 14 = 0": // se o desafio aleatório for x2 - 5x - 14 = 0, a resposta pra ele é a solucao1Evento1 e solucao2Evento1.
                double solucao1Evento1 = -2;
                double solucao2Evento1 = 7;
                if ((resposta1 == solucao1Evento1 && resposta2 == solucao2Evento1) || (resposta1 == solucao2Evento1 && resposta2 == solucao1Evento1)) { // Teste para verificar a resposta.
                    System.out.println("Conseguimos!");
                } else {
                    System.out.println("Sua aventura Termina aqui.");
                    gameOver(); // Errou chama o método gameOver e o jogo se encerra aqui.
                    // Mesma lógica foi usada nas outras cases.
                }
                break;
            case "x^2 - 12x + 20 = 0":
                double solucao1Evento2 = 10;
        ...
        System.out.println("Vocês correm para dentro dela e percebem o caos que é esta sala, números e letras descontrolados de um lado para o outro, a influência do Tetraedron sobre eles.");
        ...
        System.out.println("Matiarcs: Não estamos conseguindo encontrar a equação os números não param nao há um padrão.");
        System.out.println("1 - " + nomePersonagem + ": Verdade tambem não consegui encontrar um padrão, nao sei o que podemos fazer.");
        System.out.println("2 - " + nomePersonagem + ": Calma vamos conseguir algo deve estar passando batido.");
        System.out.println("3 - " + nomePersonagem + ": Realmente nem espaço para fazer uma gracinha estou conseguindo achar.");

        int escolha3; // Mais um diálogo.

        do { // Laço para verificar se o usuario digitou uma opção válida.
            System.out.println("O que você fará nesse momento?");
            escolha3 = scanner.nextInt();
            if (escolha3 < 1 || escolha3 > 3) {
                System.out.println("Receio ué nao haja essa escolha. Tente novamente:");
            }
        } while (escolha3 < 1 || escolha3 > 3);

        if (escolha3 == 1 || escolha3 == 2) { // Executa o texto referente a escolha.
        ...
        System.out.print("x' = ");
        double resposta3 = scanner.nextDouble(); // Armazena a resposta.
        System.out.print("x'' = ");
        double resposta4 = scanner.nextDouble(); // Armazena a resposta.

        switch (eventoAleatorioEscolhido3) {  // switch para para verificar qual desafio está na variável eventoAleatorioEscolhido3, e destinar a resposta correta para o desafio.
            case "x2 - 5x - 14 = 0": // se o desafio aleatório for x2 - 5x - 14 = 0, a resposta pra ele é a solucao1Evento1 e solucao2Evento1.
                double solucao1Evento1 = -2;
                double solucao2Evento1 = 7;
                if ((resposta3 == solucao1Evento1 && resposta4 == solucao2Evento1) || (resposta3 == solucao2Evento1 && resposta4 == solucao1Evento1)) { // Teste para verificar a resposta.
                    System.out.println("A sala antes conturbada e baralhuenta se transformara em um silencio ensurdecedor."); // acertou executa o texto e continua o código.
                } else {
                    System.out.println("Sua aventura Termina aqui.");
                    gameOver(); // Errou chama o método gameOver e encerra o jogo aqui.
                    // A mesma lógica está presente nas outras cases.
                }
                break;
            case "x^2 - 12x + 20 = 0":
                double solucao1Evento2 = 10;
                ...
                if ((resposta3 == solucao1Evento2 && resposta4 == solucao2Evento2) || (resposta3 == solucao2Evento2 && resposta4 == solucao1Evento2)) {
                    System.out.println("A sala antes conturbada e baralhuenta se transformara em um silencio ensurdecedor.");
                } else {
                    System.out.println("Sua aventura Termina aqui.");
                    gameOver();
                }
        ...
        int escolhaFinal = scanner.nextInt(); // Última escolha do jogo, aberta para dois finais, se escolher a opção1 terá um textinho para ela, e se for opção2 o textinho será diferente.

        if (escolhaFinal == 1) { // Executa final para escolha = 1.
        ...
        } else if (escolhaFinal == 2) { // Executa final para escolha = 2.
        ...
        System.out.println("Fim do jogo. Obrigado por jogar!"); // Fim do jogo.
        mainMenu(); // Chama o método mainMenu.
    }

    public static String obterNomeDoUsuario() { // Método para obter o nome do usuário.
        Scanner scanner = new Scanner(System.in);
